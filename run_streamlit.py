...
def add_instructions():
    ...
    * `Academic-Only` will select all available datasets, including those that restrict to only academic uses.
    ...
    4. Select whether to ignore the [OpenAI Terms of Use](https://openai.com/policies/terms-of-use) as a Non-Commercial restriction, and include datasets that are at least partially **generated by
